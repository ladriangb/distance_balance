...
<html>
    ...
    <body>
        ...
        <div id="show-hospital" class="content scaffold-show" role="main">
            ...
            <f:display bean="hospital" />
            <g:form resource="${this.hospital}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.hospital}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
